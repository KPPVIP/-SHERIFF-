...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		align    = 'top-left',
		elements = {
			{label = '<span style="color:orange;">Status de l\'agent ', value = 'status'},
			{label = '<span style="color:#00cc00;">Interaction Citoyen ', value = 'citizen_interaction'},
			...
			{label = '<span style="color:#669999;">Poser/Récupérer votre radar', value = 'radar'},
			{label = '<span style="color:#ff6600;">Demande renfort', value = 'renfort'}
...
Citizen.CreateThread(function()
	...
	for k,v in pairs(Config.PoliceStations) do
		...
		BeginTextCommandSetBlipName("STRING")
		AddTextComponentString("BCSO - Poste Principale")
